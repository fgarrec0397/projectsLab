import type { DefaultEventsMap, EventNames, EventsMap } from "@socket.io/component-emitter";
...
>(
    ...
    if (typeof socket === "string") {
        const eventsOptions = event as
            | (UseSocketEventOptions<ListenMessageType> & UseSocketOptions)
            | undefined;
        options = eventsOptions;
        enabled = eventsOptions?.enabled ?? true;
        event = socket;
        socket = useSocket(eventsOptions).socket;
    }
